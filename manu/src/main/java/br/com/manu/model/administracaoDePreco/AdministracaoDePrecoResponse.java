...
public class AdministracaoDePrecoResponse {
    private long codigo;
    ...
    public AdministracaoDePrecoResponse() {

    }

    public AdministracaoDePrecoResponse(long codigo, String descricaoItem, double precoAtual, double valorCusto, double margemAtual,
                                        double margemProposta, double precoProposto) {
        this.codigo = codigo;
